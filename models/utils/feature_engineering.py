...
def load_data(data_dir):
    ...
    assert os.path.isfile(data_path) and data_path.endswith('.csv'), "Invalid file within data directory"
    data = pd.read_csv(data_path, sep='\t')
    print(f"Extracting original data, data number: {len(data)}, feature number: {len(data.columns)}")
    data = data.dropna()
    # date processing
